...
class Children extends Component
{
    ...
    public function submitChildFormModal($courseModal, $sectorModal, $trang_thai)
    {
    ...
    public function updateChild()
    {
        ...
        try {
            ...
            $religiousProfileData['ngay_bo_hoc'] = ($this->trang_thai === 'Đã nghỉ') ? now() : null;
