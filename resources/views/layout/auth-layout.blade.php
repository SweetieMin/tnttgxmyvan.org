...
<head>
    ...
    <link rel="apple-touch-icon" href="/images/site/{{ isset(settings()->site_favicon) ? settings()->site_favicon : 'FAVICON_default.png' }}">
            ...
            <div class="brand-logo">
                <a href="/">
                    <img src="/images/site/{{ isset(settings()->site_logo) ? settings()->site_logo : 'LOGO_default.png' }}"
                        alt="{{ isset(settings()->site_title) ? settings()->site_title : 'Đoàn TNTT Giáo Xứ Mỹ Vân' }}" />
                </a>
            </div>
        </div>
    </div>
