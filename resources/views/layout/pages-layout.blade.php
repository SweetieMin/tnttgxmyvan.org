...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
        href="/images/site/{{ settings()->site_favicon ?? 'FAVICON_default.png' }}" />
    ...
    <script src="{{ asset('extra-assets/jquery-3.7.1/jquery-3.7.1.min.js') }}"></script>
    @kropifyStyles
    @stack('stylesheets')
</head>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            @livewire('settings.top-user-info')
