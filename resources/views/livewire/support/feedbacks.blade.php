<div>
                        ...
                        <div class="tab-pane fade {{ $tab === 'tabMain' ? 'active show' : '' }}" id="tabMain"
                            ...
                            <div class="table-responsive mt-2">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($listFeedbacksPendingAndInProgress as $feedback)
                                            <tr>
                                                <td class="text-center">{{ $loop->iteration }}</td>
                                                <td class="text-center">{{ $feedback->title }}</td>
                                                <td class="text-center">{{ $feedback->formatted_created_at }}</td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item text-danger" href="javascript:;"
                                                                    wire:click="deleteFeedback({{ $feedback->id }})"><i
                        ...
                        <div class="tab-pane fade {{ $tab === 'tabResolved' ? 'active show' : '' }}" id="tabResolved"
                            ...
                            <div class="table-responsive mt-2">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($listFeedbacksResolved as $feedback)
                                            <tr>
                        ...
                        <div class="tab-pane fade {{ $tab === 'tabCancel' ? 'active show' : '' }}" id="tabCancel"
                            ...
                            <div class="table-responsive mt-2">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($listFeedbacksCanceled as $feedback)
                                            <tr>
    ...
    <div wire:ignore.self class="modal fade" id="feedback_modal" tabindex="-1" schedule="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form wire:submit.prevent="{{ $isUpdateFeedbackMode ? 'updateFeedback()' : 'createFeedback()' }}"
                class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">
                        {{ $isUpdateFeedbackMode ? 'Cập nhật' : 'Thêm góp ý' }}
                    </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 mt-2">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('feedback_title') is-invalid @enderror"
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="form-group">
                                ...
                                <textarea wire:model="feedback_content" id="feedback_content"
                                    class="form-control @error('feedback_content') is-invalid @enderror" rows="5"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled"
                        wire:target="{{ $isUpdateFeedbackMode ? 'updateFeedback()' : 'createFeedback()' }}">
                        <span wire:loading.remove wire:target="{{ $isUpdateFeedbackMode ? 'updateFeedback()' : 'createFeedback()' }}">
                            {{ $isUpdateFeedbackMode ? 'Lưu thay đổi' : 'Thêm góp ý' }}
                        </span>
                        <span wire:loading wire:target="{{ $isUpdateFeedbackMode ? 'updateFeedback()' : 'createFeedback()' }}">
                            <span class="spinner-border spinner-border-sm mr-1" role="status"
                                aria-hidden="true"></span>
                            Đang tải...
                        </span>
