                                        ...
                                        @forelse ($listPendingAndInProgress as $complaint)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $complaint->isHideUser ? 'Ẩn danh' : $complaint->user->SimpleName }}
                                                </td>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form wire:submit.prevent='supportModalSubmit()' class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"
                        class="btn btn-{{ $support_status === 'in_progress' ? 'primary' : 'danger' }}"
                        {{ $support_status === 'in_progress' ? '' : 'disabled' }} wire:loading.attr="disabled"
                        wire:target="supportModalSubmit()">
                        <span wire:loading.remove wire:target="supportModalSubmit()">
                            {{ $support_status === 'in_progress' ? 'Xử lý xong' : 'Chưa phân công' }}
                        </span>
