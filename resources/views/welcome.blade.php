...
@section('meta_tags')
    <title>{{ isset(settings()->site_title) ? settings()->site_title : 'Đoàn Thiếu Nhi Thánh Thể Giáo Xứ Mỹ Vân' }}</title>
    <meta name="description"
        content="{{ isset(settings()->site_meta_description) ? settings()->site_meta_description : 'Đoàn Thiếu Nhi Thánh Thể Giáo Xứ Mỹ Vân' }}">
    <meta name="keywords" content="{{ isset(settings()->site_meta_keywords) ? settings()->site_meta_keywords : 'Đoàn TNTT, Giáo xứ Mỹ Vân, Thiếu Nhi Thánh Thể, Huynh Trưởng, sinh hoạt Công Giáo' }}">
    <meta name="author" content="Toma Nguyễn Khắc Huấn">

    <meta property="og:title"
        content="{{ isset(settings()->site_title) ? settings()->site_title : 'Đoàn Thiếu Nhi Thánh Thể Giáo Xứ Mỹ Vân' }}">
    <meta property="og:description"
        content="{{ isset(settings()->site_meta_keywords) ? settings()->site_meta_keywords : 'Đoàn TNTT, Giáo xứ Mỹ Vân, Thiếu Nhi Thánh Thể, Huynh Trưởng, sinh hoạt Công Giáo' }}">
