            ...
            <div class="col-md-6">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
            ...
            <div class="col-md-6">
                <div class="clearfix mt-2">
                    ...
                    <div class="pull-right">
                        <a href="javascript:;" wire:click="showAllThieuNhi" class="btn btn-primary btn-sm mr-2"
                            wire:loading.attr="disabled">

                            <span wire:loading.remove wire:target="showAllThieuNhi">Xem tất cả</span>
                            <span wire:loading wire:target="showAllThieuNhi">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                             <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $topThieuNhi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $bangDiemTatCa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $userModal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
...
<?php /**PATH /Users/smyth/Herd/tnttgxmyvan.org/resources/views/livewire/dashboard/children.blade.php ENDPATH**/ ?>