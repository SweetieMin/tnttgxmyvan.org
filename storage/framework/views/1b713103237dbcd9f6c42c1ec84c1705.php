...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <p>Chúng mình đã nhận được yêu cầu xác minh cho tài khoản của bạn. Nếu bạn muốn xác minh email, hãy nhấp vào
                nút bên dưới:</p>
            <div class="text-center"><a href="<?php echo e($actionLink); ?>" class="btn" style="color: #ffffff">Xác minh tài
                    khoản</a></div>
...
<?php /**PATH /Users/smyth/Herd/tnttgxmyvan.org/resources/views/Mail/auth/verification-email.blade.php ENDPATH**/ ?>