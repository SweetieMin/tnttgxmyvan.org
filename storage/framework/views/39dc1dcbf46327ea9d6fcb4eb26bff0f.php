                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr data-index="<?php echo e($role->id); ?>" data-ordering="<?php echo e($role->ordering); ?>">
                                    ...
                                    <td class="text-center">
                                        <!--[if BLOCK]><![endif]--><?php if($role->type == 'System'): ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if($isUpdateRoleMode): ?>
                    ...
                    <div class="form-group">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['role_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="form-group">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['role_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
