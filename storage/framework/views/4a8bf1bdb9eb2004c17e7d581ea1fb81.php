            ...
            <div class="col-md-6">
                ...
                <div wire:ignore class="table-responsive mt-2">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topHuynhTruong; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
            ...
            <div class="col-md-6">
                ...
                <div wire:ignore class="table-responsive mt-2">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topThieuNhi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="text-center"><?php echo e($index + 1); ?></td>
                                    <td class="text-center"><?php echo e($user->SimpleName); ?></td>
                                    <td class="text-center"><?php echo e($user->total_score); ?></td>
