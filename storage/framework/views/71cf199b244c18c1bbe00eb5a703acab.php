...
[$__name, $__params] = $__split('dashboard.leaders');

$__html = app('livewire')->mount($__name, $__params, 'lw-1839170623-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        document.addEventListener('showTransactionDetails', function() {
            $('#showTransactionDetails').modal('show');
        });
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layout.pages-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/smyth/Herd/tnttgxmyvan.org/resources/views/back/dashboard/leader-Dashboard.blade.php ENDPATH**/ ?>