    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "name": "<?php echo e(isset(settings()->site_title) ? settings()->site_title : 'Đoàn Thiếu Nhi Thánh Thể Giáo Xứ Mỹ Vân'); ?>",
        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div class="login-menu">
                <ul>
                    ...
                    <?php else: ?>
                        <li><a href="<?php echo e(route('admin.login')); ?>">Đăng nhập</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
...
</html><?php /**PATH /Users/smyth/Herd/tnttgxmyvan.org/resources/views/layout/profile.blade.php ENDPATH**/ ?>