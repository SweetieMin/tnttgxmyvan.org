                ...
                <div wire:loading.class="opacity-50" wire:target="page">
                    <div class="table-responsive mt-4">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $listScouters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Scouter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <?php if($Scouter->hasCustomPicture()): ?>
                                                        <a class="dropdown-item" href="javascript:;"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $__errorArgs = ['scouter_birthday'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $__errorArgs = ['scouter_holy_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="scouter_full_name"
                                    ...
                                    oninput="this.value = this.value.replace(/(^|\s)\S/g, char => char.toLocaleUpperCase())">
                                <?php $__errorArgs = ['scouter_full_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="scouter_address"
                                    ...
                                    oninput="this.value = this.value.replace(/(^|\s)\S/g, char => char.toLocaleUpperCase())">
                                <?php $__errorArgs = ['scouter_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="col-md-6">
                            <div wire:ignore class="form-group">
                                ...
                                <select class="selectpicker form-control" id="roleModal" data-size="5"
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $listRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $__errorArgs = ['scouter_father_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $__errorArgs = ['scouter_mother_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
