            ...
            <div class="col-lg-7 col-md-9 col-sm-11">
                <div class="card shadow-lg">
                    ...
                    <div class="card-footer text-center">
                        <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-primary btn-lg">Đăng nhập</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/smyth/Herd/tnttgxmyvan.org/resources/views/Mail/auth/notify-verify-email.blade.php ENDPATH**/ ?>