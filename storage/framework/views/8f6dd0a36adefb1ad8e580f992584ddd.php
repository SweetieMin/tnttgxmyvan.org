...
[$__name, $__params] = $__split('support.feedbacks');

$__html = app('livewire')->mount($__name, $__params, 'lw-119355945-0', $__slots ?? [], get_defined_vars());
        ...
        window.addEventListener('showFeedbackModal', function() {
            ...
            if (!Dropzone.instances.length) {
                const dz = new Dropzone("#feedback_picture", {
                    url: "<?php echo e(route('admin.support.feedback.upload_image')); ?>",
                    paramName: "file",
                    maxFilesize: 2,
                    maxFiles: 4,
                    acceptedFiles: "image/*",
                    ...
                    removedfile: function(file) {
                        ...
                        fetch("<?php echo e(route('admin.support.feedback.delete_image')); ?>", {
                                method: "POST",
                                headers: {
...
<?php echo $__env->make('layout.pages-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/smyth/Herd/tnttgxmyvan.org/resources/views/back/support/feedback.blade.php ENDPATH**/ ?>