            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="table-responsive mt-1">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $listChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
            ...
            <form class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($showDisciplinesScouter): ?>
                            <div class="col-md-8">
                                <div wire:ignore class="form-group">
                                    ...
                                    <select class="selectpicker form-control" id="user_discipline_scouter"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $disciplinesModal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($showDisciplinesChildren): ?>
                            <div class="col-md-8">
                                <div wire:ignore class="form-group">
                                    ...
                                    <select class="selectpicker form-control" id="user_discipline_children"
                                        ...
                                        data-style="btn-outline-warning" data-live-search="true"
                                        data-none-selected-text="Chọn lỗi vi phạm">
                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $disciplinesModalChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['user_discipline_name'];
