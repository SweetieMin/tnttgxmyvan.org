            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $listSchedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form class="modal-content">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if($isUpdateScheduleMode): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['schedule_name'];
                        ...
                        <div class="col-md-6">
                            <div wire:ignore class="form-group">
                                ...
                                <select id="schedule_type" class="form-control selectpicker"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $listRegulation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-4 col-sm-6 mt-2">
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['schedule_start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-4 col-sm-6 mt-2">
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['schedule_end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
