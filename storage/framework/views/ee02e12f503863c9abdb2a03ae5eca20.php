        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasResolvePermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasAssignedPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isShowAttendanceMenu): ?>
                        <li>
                            <div class="dropdown-divider"></div>
                        </li>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasRewardPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasDisciplinePermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasConfirmPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isShowPersonnelMenu): ?>
                        <li>
                            <div class="dropdown-divider"></div>
                        </li>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasScouterPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasChildrenPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isShowManageMenu): ?>
                        <li>
                            <div class="dropdown-divider"></div>
                        </li>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasCoursePermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasSectorPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasBiblePermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasRegulationPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasSchedulePermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasTransactionPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasNoticePermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasManagerPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasActivityLogsPermission): ?>
                        <li>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasGeneralSettingsPermission): ?>
                        <li>
